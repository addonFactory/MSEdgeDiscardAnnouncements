...
addon_info = {
	...
	"addon_summary": "Microsoft Edge discard announcements",
	# Add-on description
	...
	"addon_url": "https://github.com/addonfactory/MSEdgeDiscardAnnouncements",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/addonFactory/MSEdgeDiscardAnnouncements",
